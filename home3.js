  ...
  confirmationBox.remove();
        ...
        function caluculatingvalues(date, Formid, R_BANK_RASHI) {
            ...
            if (rbTotalData) {
                ...
                nagadpurve_Shesh =
                    parseFloat(nagadpurve_Shesh) + parseFloat(r_nagadAmount);
                bankpurve_Shesh =
                    parseFloat(bankpurve_Shesh) + parseFloat(r_bankAmount);
                ...
                nagadpurve_Shesh =
                    parseFloat(nagadpurve_Shesh) - parseFloat(b_nagadAmount);
                bankpurve_Shesh =
                    parseFloat(bankpurve_Shesh) - parseFloat(b_bankAmount);
        ...
        function pnyd() {
            ...
            document.getElementById("panchaya_year").innerText =
                panchaya_data["Year"];
        }
        ...
        function addbtn() {
            window.location.href = "Input Forms/rokadform.html";
        }
